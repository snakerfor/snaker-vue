<template>
  <a-card :bordered="false">
    ...
    <s-table size="default" ref="table" rowKey="id" :rowSelection="rowSelection" :columns="columns" :data="loadData">
    ...
    <a-modal :visible="modelVisible" title="Activiti工作流在线流程设计编辑" :footer="null" :width="1500" centered @cancel="modelCancel">
...
export default {
  ...
  methods: {
    ...
    handleEdit (id) {
      this.modelVisible = true
      this.modelerUrl = modelerBaseUrl + '/models/editModel/' + id + '?time=' + new Date().getTime()
    },
    handleOk () {
