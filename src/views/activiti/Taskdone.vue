<template>
  <a-card :bordered="false">
    ...
    <s-table size="default" ref="table" rowKey="auditId" :rowSelection="rowSelection" :columns="columns" :data="loadData">
...
import { getTaskdone, delTaskLogic, processInsState } from '@/api/activiti'
