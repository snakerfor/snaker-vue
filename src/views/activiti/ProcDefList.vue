<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-upload v-if="addEnable" name="file" :action="uploadUrl" :headers="headers" :showUploadList="false" @change="uploadChange">
        <a-button icon="upload">部署流程文件</a-button>
      </a-upload>
    </div>
    <s-table size="default" ref="table" rowKey="deploymentId" :rowSelection="rowSelection" :columns="columns" :data="loadData">
      ...
      <span slot="action" slot-scope="text, record">
        ...
        <a-popconfirm placement="topRight" title="该操作会一并 激活/挂起 所有流程实例?" @confirm="handleState(record)" okText="是" cancelText="否" v-if="editEnabel">
