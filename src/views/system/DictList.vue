<template>
  <a-card :bordered="false">
    ...
    <s-table size="default" ref="table" rowKey="dictId" :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" :columns="columns" :data="loadData" defaultSort="createTime">
