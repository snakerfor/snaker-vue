<template>
  <a-card :bordered="false">
    ...
    <s-table size="default" ref="table" rowKey="configId" :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" :columns="columns" :data="loadData" :rangPicker="range" defaultSort="createTime">
