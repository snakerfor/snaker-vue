<template>
  <div class="main">
    <a-form id="formLogin" class="user-layout-login" ref="formLogin" :form="form" @submit="handleSubmit">
      ...
      <a-form-item>
        <a-input size="large" type="password" autocomplete="false" placeholder="密码: admin123" v-decorator="[
          'password',
      ...
      <a-form-item>
        ...
        <!-- <router-link :to="{ name: 'recover', params: { user: 'aaa'} }" class="forge-password" style="float: right;color:blue;text-decoration: underline;">培训资料</router-link> -->
      </a-form-item>
    ...
    <Verify @success="capctchaCheckSucc" :mode="'pop'" :captchaType="'clickWord'" :imgSize="{ width: '330px', height: '155px' }" ref="verify"></Verify>
  </div>
</template>
